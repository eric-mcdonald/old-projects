...
public final class ClampedNumber<N extends Number & Comparable<N>> extends Number
		implements Comparable<ClampedNumber<?>> {
	...
	public int compareTo(ClampedNumber<?> o) {
		...
		return fromVal.getClass().isInstance(toVal) ? fromVal.compareTo((N) toVal) : 0;
	}
