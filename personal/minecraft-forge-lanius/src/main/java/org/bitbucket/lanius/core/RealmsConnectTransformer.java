...
public final class RealmsConnectTransformer extends BasicTransformer {

	private final class RealmsConnectVisitor extends ClassVisitor {

		public RealmsConnectVisitor(ClassVisitor cv) {
			super(ASM5, cv);
	...
	public RealmsConnectTransformer() {
		super("net/minecraft/client/realms/RealmsConnect$1");
		// TODO Auto-generated constructor stub
	}
	...
	protected ClassVisitor classVisitor(final ClassWriter classWriter) {
		...
		return new RealmsConnectVisitor(classWriter);
	}
