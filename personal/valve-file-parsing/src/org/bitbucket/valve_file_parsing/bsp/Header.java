...
public class Header {
	public static final int LUMP_ENTITIES					= 0,	// *
			...
			LUMP_OVERLAY_FADES				= 60, LUMP_OVERLAY_SYSTEM_LEVELS = 61, LUMP_PHYSLEVEL = 62, LUMP_DISP_MULTIBLEND = 63;	// Fade distances for overlays
	public static final int HEADER_LUMPS = 64;
	public final int identifier, version;
	public final Lump[] lumps;
	public final int mapRevision;
	
	public Header(final int identifier, final int version, final Lump[] lumps, final int mapRevision) {
